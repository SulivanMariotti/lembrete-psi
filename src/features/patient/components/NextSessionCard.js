...
import { BriefcaseMedical, CalendarCheck, MapPin, MessageCircle, UserRound } from "lucide-react";
  ...
  if (!nextAppointment) {
    return (
      <Card
        ...
        className="border-violet-100 ring-1 ring-violet-100/70 bg-gradient-to-br from-violet-50/40 via-white to-white"
      >
              ...
              <div className="mt-3 grid grid-cols-1 gap-2 text-sm text-slate-600">
                <div className="flex items-start gap-2">
                  ...
                  <div className="leading-snug">
                    ...
                    <div className="font-semibold text-slate-800 whitespace-normal break-words">
                ...
                <div className="flex items-start gap-2">
                  ...
                  <div className="leading-snug">
                    ...
                    <div className="font-semibold text-slate-800 whitespace-normal break-words">{profissional}</div>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-2">
                  ...
                  <div className="leading-snug">
                    ...
                    <div className="font-semibold text-slate-800 whitespace-normal break-words">{place}</div>
                  </div>
                </div>
