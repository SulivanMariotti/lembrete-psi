...
- Guia do próximo passo: Capacitor mantendo WEB

## Changed
- `PatientFlow` modularizado e mais leve
- Layout mobile mais compacto e legível
- “Seu Próximo Atendimento” com destaque sutil
