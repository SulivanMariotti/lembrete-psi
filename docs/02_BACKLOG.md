...
- [ ] Estabilizar preview “Amostra” (`sample`) no dryRun
- [ ] Corrigir fluxo “Limpar” + reprocessar sem travar estado
- [ ] Garantir visibilidade consistente de “Disparos por constância”
- [ ] Processar segunda planilha/relatório de presença/faltas para painel de constância e notificações futuras
